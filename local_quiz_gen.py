...
async def gen_paintings(book_name="창세기", painting_name="unknown", how_many=10, progress_text=None, progress_bar=None):
    header_query= f"Generate {how_many} of Bible quiz questions for book name: {book_name} in Korean. but it has to be somewhat related to Christian masterpiece paintings, the name of the painting is {painting_name}"
